...
ICON_FILES = {
    ...
    "light": os.path.join("ikonlar", "light.svg"),
    "search": os.path.join("ikonlar", "search.svg"),
    "volume_off": os.path.join("ikonlar", "volume_off.svg"),
    "volume_up": os.path.join("ikonlar", "volume_up.svg"),
    "copy": os.path.join("ikonlar", "copy.svg"),
}
