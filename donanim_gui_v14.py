...
def is_searchable_item(text):
    ...
    # Model kodları genelde hem harf hem rakam içerir: MS-7D22, G24F 2, VX2458 gibi.
...
class HardwareApp(ctk.CTk):
    def __init__(self):
        ...
        self.sound_button.pack(pady=(8, 4), padx=20, fill="x")
        ...
        self.animation_button.pack(pady=(4, 10), padx=20, fill="x")
    ...
    def toggle_sound(self):
        ...
        if self.sound_enabled:
            self.sound_button.configure(text="Ses: Açık")
        else:
            self.sound_button.configure(text="Ses: Kapalı")

    def toggle_animation(self):
        self.animation_enabled = not self.animation_enabled

        if self.animation_enabled:
            self.animation_button.configure(text="Animasyon: Açık")
        else:
            self.animation_button.configure(text="Animasyon: Kapalı")
    ...
    def play_pop_sound(self):
        ...
        def sound_job():
            try:
                winsound.Beep(620, 35)
                winsound.Beep(820, 45)
            except:
                try:
        ...
        threading.Thread(target=sound_job, daemon=True).start()
    ...
    def update_refresh_spinner(self):
        ...
        self.after(180, self.update_refresh_spinner)
    ...
    def animate_card_entry(self, card, step=0):
        ...
        padx_values = [34, 28, 22, 16, 10, 5]
        pady_values = [16, 15, 14, 13, 12, 10]
        ...
        try:
            ...
            self.after(24, lambda: self.animate_card_entry(card, step + 1))
        except:
            pass
    ...
    def add_card(self, title, items, searchable=True):
        ...
        if self.animation_enabled:
            card.pack(fill="x", padx=34, pady=16)
        else:
